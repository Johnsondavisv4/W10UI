...
exit /b
)RRnet session >nul 2>&1Rif %errorLevel% neq 0 (R    echo Solicitando permisos de administrador...R    powershell -Command "Start-Process -FilePath "%~f0" -ArgumentList "%*" -Verb RunAs"R    exitR)
