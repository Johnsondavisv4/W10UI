...
set DEFAULTLANGUAGE=es-MX
set MOUNTDIR=

set WINPEPATH=
set CUSTOMLANGINI=lang.ini
...
set "CUSTOMLANGFILE=%WORKDIR%\..\%CUSTOMLANGINI%"
...
if %_i%==%imgcount% (
if exist "!CUSTOMLANGFILE!" (
copy /y "!CUSTOMLANGFILE!" "!DVDDIR!\sources\lang.ini" %_Nul1%
) else (
...
if %_stp% EQU 1 (
if exist "!CUSTOMLANGFILE!" (
copy /y "!CUSTOMLANGFILE!" "%BOOTMOUNTDIR%\sources\lang.ini" %_Nul1%
) else (
